...
const trashPool = {
  ...
  organic: [
    ...
    {img:"https://www.allthatgrows.in/cdn/shop/products/Carrot-Orange.jpg"}
  ],
  electronics: [
...
window.rewind=function(){
  ...
  if(last && last.type===trashItems[currentIndex].type) correct--;
  showTrash();
};
